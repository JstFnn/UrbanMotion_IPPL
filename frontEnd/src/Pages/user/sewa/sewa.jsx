    ...
    if (!tokenUser) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          // Jika pengguna mengklik "Login Sekarang", arahkan ke halaman login
          window.location.href = "/login"; // Ganti '/login' dengan URL halaman login Anda
        }
      });
      return; // Menghentikan eksekusi fungsi jika pengguna belum login
    }
            ...
            <div className="payment-category">
              ...
              <div className="payment-method-list">
                ...
                <div className="col-6">
                  <PaymentMethodItem
                    imgUrl={
                      "https://storage.googleapis.com/go-merchant-production.appspot.com/uploads/2024/10/b8ed83a966c951414a2c0ababa0b6987_377d64303a92b5d124043e753ae85f64_compressed.png"
                    }
                    title={"Permata Bank"}
                    value={"permata_va"}
                    onChange={handleChange}
                  ...
                  <PaymentMethodItem
                    imgUrl={
                      "https://storage.googleapis.com/go-merchant-production.appspot.com/uploads/2023/08/edd9f22258760cc127712d1292f8a10a_e4b59ee9f4466d7d808dc89f031da7a6_compressed.png"
                    }
                    title={"CIMB Niaga"}
                    value={"cimb_va"}
                    onChange={handleChange}
            ...
            <div className="payment-category ">
              ...
              <div className="payment-method-list">
                <div className="col-6">
                  ...
                  <PaymentMethodItem
                    imgUrl={
                      "https://media.licdn.com/dms/image/v2/D560BAQECqUQSToxRoQ/company-logo_200_200/company-logo_200_200/0/1700729590328/akulaku_logo?e=2147483647&v=beta&t=PpvLrRhY2ZH3w3B8GRqyU2FS5eZak27IwYaUS--oCP4"
                    }
                    title={"Akulaku"}
                    value={"akulaku"}
                    onChange={handleChange}
            ...
            <div className="details">
              ...
              <p className="price-line">
                ...
                <strong className="price">
                  {bookingData.price && bookingData.totalDays
                    ? `${formatRupiah(bookingData.price * bookingData.totalDays)}`
                    : "-"}
                </strong>
              </p>
              ...
              <p className="price-line">
                ...
                <strong className="price">
                  {bookingData.driver && bookingData.driver !== "tanpa driver" ? ` ${formatRupiah(200000)}` : "-"}
                </strong>
              </p>
              <hr />
              <p className="total">
                ...
                <strong className="price">
                  {bookingData.price && bookingData.totalDays
                    ? ` ${formatRupiah(totalAmount(bookingData.price, bookingData.totalDays, bookingData.driver))}`
                    : "-"}
                </strong>
              </p>
